      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="leading-relaxed text-gray-700 mb-4">
            Travelsense provides driving information to help you plan a road
            trip. You can measure the{" "}
            <a
            ...
            between two cities based on actual turn-by-turn directions. Or
            figure out the{" "}
            <a
              href="#driving-time"
              className="text-blue-700 font-semibold hover:underline"
            ...
            or if you can drive straight through. To stay within your budget,
            make sure you calculate the{" "}
            <a
