...
export default function CitiesNearby() {
  const [path, setPath] = useState("cities-near"); // default selection -> Cities Nearby
  ...
  const handleSubmit = async (e) => {
    ...
    // For two-location calculations (distance, driving time, etc.) require both locations
          ...
          <main className="flex-1">
            <div className="w-full">
              ...
              <article className="prose prose-lg text-gray-700 mt-10">
                <h2 className="text-2xl font-bold text-[#05296B] pb-2">Cities near other towns</h2>
                <p>
