...
export default function StopingPoint() {
  const [path, setPath] = useState("stopping-points"); // default selection -> Stopping Points
          ...
          <main className="flex-1">
            <div className="w-full">
              ...
              >
                ...
                {result && (
                  <div className="mt-4 p-4 bg-gray-50 rounded">
                    ...
                    {result.locationName ? (
                      <div className="text-sm mt-2">Showing results for: <strong>{result.locationName}</strong>
                      ...
                      <>
                        ...
                        {result.drivingHours && (
                          <div className="text-sm">Estimated driving time: {Math.floor(result.drivingHours)} hour(s) {Math.round((result.drivingHours % 1) * 60)} minute(s)</div>
                        )}
                      </>
                    )}
                  </div>
              ...
              <article className="prose prose-lg text-gray-700 mt-10">
                <h2 className="text-2xl font-bold text-[#05296B] pb-2">Driving Time Between Cities</h2>
                <p>
