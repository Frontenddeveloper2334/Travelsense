...
export default function HalfwayPoint() {
  const [path, setPath] = useState("halfway"); // default selection -> Halfway Point
  ...
  const handleSubmit = async (e) => {
    ...
    // For two-location calculations (distance, driving time, halfway point, etc.) require both locations
    ...
    try {
      ...
      // Simple geographic midpoint (average lat/lon) — acceptable approximation for UI
          ...
          <main className="flex-1">
            <div className="w-full">
              ...
              <article className="prose prose-lg text-gray-700 mt-10">
                <h2 className="text-2xl font-bold text-[#05296B] pb-2">Halfway Point Between Cities</h2>
                <p>
                  Use the Halfway Point calculator to find the geographic midpoint between two locations. Enter the origin and destination, then press GO — we will estimate the midpoint coordinates and show distance and approximate driving time between the two points.
                </p>

                <p>
                  The midpoint shown is a simple average of latitude and longitude — useful for planning meetups, estimating a stopover city, or finding a central location between two places.
                </p>
              </article>
            </div>
          </main>
